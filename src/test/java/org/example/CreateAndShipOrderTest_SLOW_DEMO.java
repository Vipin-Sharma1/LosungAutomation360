...
public class CreateAndShipOrderTest_SLOW_DEMO {

    // =========================================================
    // DEMO / HUMAN-VISIBLE SPEED
    // =========================================================
    // Increase these values if you want the automation even slower.
    private static final long TYPING_DELAY_MS = 120;   // delay between characters
    private static final long FIELD_PAUSE_MS = 500;    // pause after each field
    private static final long ACTION_PAUSE_MS = 800;   // pause after important clicks
    ...
    public void setup() {
        ...
        // Connect Selenium to the Chrome instance that was started
        // with remote debugging and already contains the Losung360 login session.
    ...
    public void fillCustomerDetails() {
        ...
        for (char ch : pincode.toCharArray()) {
            pincodeInput.sendKeys(String.valueOf(ch));
            pause(TYPING_DELAY_MS);
        }
        pause(FIELD_PAUSE_MS);
    ...
    public boolean searchAndShipOrder() {
        ...
        searchBox.clear();
        for (char ch : orderNumber.toCharArray()) {
    ...
    /**
     * Reusable text field filler.
     *
     * Instead of sending the whole value instantly, this types one character
     * at a time so a person watching the automation can clearly see the data
     * being entered.
     */
    ...
    public void tearDown() {
        // Browser intentionally left open to inspect result.
        // Enable driver.quit() for full automated runs.
        // driver.quit();
    }
}
